...
export default function PageHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#D8DED1] bg-[#FBF9F2]/95 backdrop-blur">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-4 px-4 py-4 sm:px-6 sm:py-5 lg:px-8 lg:py-6">
